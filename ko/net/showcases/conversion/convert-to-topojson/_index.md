...
title: "TopoJSON으로 변환"
type: docs
url: /ko/net/convert-to-topojson/
weight: 70
---

Aspose.GIS for .NET 라이브러리를 사용하여 다른 인기 있는 벡터 기반 gis 파일에서 TopoJSON 파일 형식으로 변환합니다.

## **라이브 예제**

Aspose.GIS for .NET / C#는 ["TopoJSON으로 변환"](https://products.aspose.app/gis/conversion/convert-to-topojson) 애플리케이션을 온라인에서 무료로 제공하며, 기능을 조사하고 품질을 확인할 수 있습니다.

![ to TopoJSON Converter App](conversion.png)

## **코드 샘플 - TopoJSON으로 변환**

다음 코드 스니펫은 TopoJSON으로 변환하는 방법을 보여줍니다. 대상 TopoJSON 레이어에 공간 참조 시스템을 지정하면 모든 지오메트리가 해당 시스템으로 변환됩니다. 
