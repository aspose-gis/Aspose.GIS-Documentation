...
You can specify how to perform file operations for your storage by implementing a class that inherits [AbstractPath](https://apireference.aspose.com/gis/net/aspose.gis/abstractpath) and providing implementations for its abstract methods.
...
GIS data formats like GeoJSON and KML can store all data for a layer in a single file. If you can obtain a stream for the file, you can skip implementing a custom abstract path, and use method [AbstractPath.FromStream()](https://apireference.aspose.com/gis/net/aspose.gis/abstractpath/methods/fromstream) to instantiate an abstract path for the stream.
