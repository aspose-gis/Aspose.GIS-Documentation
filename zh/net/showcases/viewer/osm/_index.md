...
Aspose.GIS for .NET / C# 在线免费提供 ["OSM Viewer"](https://products.aspose.app/gis/viewer/osm) 应用程序，您可以在其中调查其功能和质量如何运作。

![OSM viewer app](viewer.png)

## **代码示例 - OSM Viewer**

以下代码片段向您展示了如何实现 OSM 查看器。下面的代码使用 OSM 层创建图像地图。如果您为地图指定空间参考系统，所有加载的图层都将转换为它。
