...
title: "GML 到 GPX 转换器"
type: docs
url: /zh/net/gml-to-gpx/
weight: 70
---

使用 Aspose.GIS for .NET 库将 GML 转换为 GPX 文件格式。

## **在线示例**

Aspose.GIS for .NET / C# 在线免费提供 ["GML 到 GPX 转换器"](https://products.aspose.app/gis/conversion/gml-to-gpx) 应用程序，您可以在其中调查其功能和质量。

![GML 到 GPX 转换器 App](conversion.png)

## **代码示例 - GML 到 GPX 转换器**

以下代码片段向您展示如何实现 GML 到 GPX 转换器。 如果您为目标 GPX 层指定了空间参考系统，则所有几何体都将转换为它。 
