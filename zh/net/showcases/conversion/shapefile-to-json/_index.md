...
type: docs
url: /zh/net/shapefile-to-json/
weight: 70
---

使用 Aspose.GIS for .NET 库将 Shapefile 转换为 JSON 文件格式。

## **在线示例**

Aspose.GIS for .NET / C# 为您提供免费的 ["Shapefile to JSON Converter"](https://products.aspose.app/gis/conversion/shapefile-to-json) 在线应用程序，您可以调查其功能和质量如何工作。

![Shapefile to JSON Converter App](conversion.png)

## **代码示例 - Shapefile to JSON Converter**

以下代码片段向您展示了如何实现 Shapefile 到 JSON 转换器。 如果您为目标 JSON 图层指定空间参考系统，则所有几何体都将转换为该系统。 
